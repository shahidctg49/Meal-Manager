              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Email/UserName/Contact</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend"></span>
                        <input type="text" value="<?= set_value('euc') ?>" class="form-control" id="yourUsername" name="euc" required>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="register">Create</a></p>
                    </div>
                  </form>
                </div>
              </div>
